...
jQuery(document).ready(function ($) {
  ...
  var preloader = function () {
    $(
      ".blog a.post-image>img, .post.single .post-image img, .services-list a>img, .projects-list:not('.isotope') a>img, .cm-preload>img"
    ).each(function () {
  ...
  $(".mobile-menu-switch").on("click", function (event) {
    ...
    if (!$(".mobile-menu-container nav .mobile-menu").is(":animated")) {
      ...
      $(".mobile-menu-container nav .mobile-menu").slideToggle(
        500,
        function () {
          if (!$(".mobile-menu-container nav .mobile-menu").is(":visible"))
  ...
  $("#basic-service-cost-2").costCalculator({
    formula:
      "basic-service-cleaning-frequency*basic-service-clean-area+basic-service-cleaning-frequency*basic-service-cleaning-supplies+basic-service-cleaning-frequency*bedrooms*10+basic-service-cleaning-frequency*bathrooms*20+basic-service-cleaning-frequency*basic-service-livingrooms*30+basic-service-cleaning-frequency*basic-service-kitchen-size+basic-service-cleaning-frequency*basic-service-bathroom-includes+basic-service-cleaning-frequency*basic-service-pets+basic-service-cleaning-frequency*basic-service-dining-room+basic-service-cleaning-frequency*basic-service-play-room+basic-service-cleaning-frequency*basic-service-laundry+basic-service-cleaning-frequency*basic-service-gym+basic-service-cleaning-frequency*basic-service-garage+basic-service-cleaning-frequency*basic-service-refrigerator-clean",
    currency: "$",
    currencyPosition: "before",
    thousandthSeparator: ",",
    decimalSeparator: ".",
  ...
  $("#premium-service-cost-2").costCalculator({
    formula:
      "premium-service-cleaning-frequency*premium-service-clean-area+premium-service-cleaning-frequency*premium-service-cleaning-supplies+premium-service-cleaning-frequency*bedrooms*10+premium-service-cleaning-frequency*bathrooms*20+premium-service-cleaning-frequency*premium-service-livingrooms*30+premium-service-cleaning-frequency*premium-service-kitchen-size+premium-service-cleaning-frequency*premium-service-bathroom-includes+premium-service-cleaning-frequency*premium-service-pets+premium-service-cleaning-frequency*premium-service-dining-room+premium-service-cleaning-frequency*premium-service-play-room+premium-service-cleaning-frequency*premium-service-laundry+premium-service-cleaning-frequency*premium-service-gym+premium-service-cleaning-frequency*premium-service-garage+premium-service-cleaning-frequency*premium-service-refrigerator-clean",
    currency: "$",
    currencyPosition: "before",
    thousandthSeparator: ",",
    decimalSeparator: ".",
  ...
  $("#post-renovation-service-cost-2").costCalculator({
    formula:
      "post-renovation-cleaning-frequency*post-renovation-clean-area+post-renovation-cleaning-frequency*post-renovation-cleaning-supplies+post-renovation-cleaning-frequency*bedrooms*10+post-renovation-cleaning-frequency*bathrooms*20+post-renovation-cleaning-frequency*post-renovation-livingrooms*30+post-renovation-cleaning-frequency*post-renovation-kitchen-size+post-renovation-cleaning-frequency*post-renovation-bathroom-includes+post-renovation-cleaning-frequency*post-renovation-pets+post-renovation-cleaning-frequency*post-renovation-dining-room+post-renovation-cleaning-frequency*post-renovation-play-room+post-renovation-cleaning-frequency*post-renovation-laundry+post-renovation-cleaning-frequency*post-renovation-gym+post-renovation-cleaning-frequency*post-renovation-garage+post-renovation-cleaning-frequency*post-renovation-refrigerator-clean",
    currency: "$",
    currencyPosition: "before",
    thousandthSeparator: ",",
    decimalSeparator: ".",
  ...
  $("#final-service-cost").costCalculator({
    formula:
      "cleaning-frequency*clean-area+cleaning-frequency*cleaning-supplies+cleaning-frequency*bedrooms*10+cleaning-frequency*bathrooms*20+cleaning-frequency*livingrooms*30+cleaning-frequency*kitchen-size+cleaning-frequency*bathroom-includes+cleaning-frequency*pets+cleaning-frequency*dining-room+cleaning-frequency*play-room+cleaning-frequency*laundry+cleaning-frequency*gym+cleaning-frequency*garage+cleaning-frequency*refrigerator-clean",
    currency: "$",
    currencyPosition: "before",
    thousandthSeparator: ",",
    decimalSeparator: ".",
  ...
  } else $(".parallax").addClass("attachment-scroll");
  ...
  var horizontalCarousel = function () {
    $(".horizontal-carousel").each(function (index) {
      ...
      $(
        ".cm-preloader-hr-carousel_" +
          index +
          ($(".cm-preloader-hr-carousel_" + index + " img:first").length
            ? " img:first"
            : "")
      )
        .one("load", function () {
          $(".cm-preloader-hr-carousel_" + index)
            .prev(".cm-preloader")
            .remove();
          $(".cm-preloader-hr-carousel_" + index).fadeTo(
            "slow",
            1,
            function () {
              $(this).css("opacity", "");
          ...
          var navigation = 1;
          var control_for = "";
          var elementClasses = $(".cm-preloader-hr-carousel_" + index)
            .attr("class")
            .split(" ");
          for (var i = 0; i < elementClasses.length; i++) {
  ...
  var counters = function () {
    $(".counters-group").each(function () {
      ...
      counterBoxes.each(function (index) {
        ...
        if (self.find("[data-value]").length) {
          currentValue = parseInt(
            self.find("[data-value]").data("value").toString().replace(" ", ""),
            10
          );
          if (currentValue > topValue) topValue = currentValue;
        }
      });
      ...
      counterBoxes.each(function (index) {
        ...
        self
          .find(".ornament-container")
          .css("height", (currentValue / topValue) * 100 + height + "%");
      });
    });
  ...
  $(".tabs").tabs({
    ...
    activate: function (event, ui) {
      ui.oldPanel
        .find(
          ".submit-contact-form, [name='submit'], [name='name'], [name='email'], [name='message']"
        )
        .qtip("hide");
    },
  });
  ...
  $(window)
    .on("hashchange", function (event) {
      ...
      if (hashSplit[0].substr(0, 11) != "prettyPhoto") {
        ...
        $(
          ".testimonials-carousel, .our-clients-list:not('.type-list')"
  ...
  function windowResize() {
    ...
    $(".testimonials-carousel").trigger("configuration", [
      "debug",
      false,
      true,
    ]);
      ...
      if (
        ...
        if (menu_position + modificator < topOfWindow) {
          if (!$("#cm-sticky-clone").hasClass("move")) {
            ...
            if ($(".transparent-header-container").length) {
              $('.header-container.sticky:not("#cm-sticky-clone")').css(
                "visibility",
                "hidden"
              );
              setTimeout(function () {
            ...
            } else $(".header-container").addClass("transition");
            $(".template-search").off("click");
            $(".template-search").on("click", function (event) {
              event.preventDefault();
              $(this).parent().children(".search").toggle();
          ...
          } else $(".header-container").removeClass("transition");
        }
      } else {
        $("#cm-sticky-clone").removeClass("move");
        if ($(".transparent-header-container").length) {
  ...
  //hint
  $(
    ".search input[type='text'], .search-form input[type='text'], .cost-calculator-container input[placeholder]:not('.cost-slider-datepicker')"
  ).hint();
  ...
  if ($(".contact-form").length) {
    ...
    /* Disabled - EmailJS handles this in custom.js
  ...
  /* EmailJS handles form submission via custom.js
  $(".contact-form").submit(function (event) {
	...
	//arrayData.pop();   // Remove kast entry from array "action" not needed
    //var data = {};
    //$.each(arrayData, function () {
    //    data[this.name] = this.value || "";
	//});
	console.log("DATOS..1.", post_data);
    ...
    $.ajax({
      url: "https://us-central1-datelica.cloudfunctions.net/sendEmailGdl",
      ...
      success: function (json) {
        self
          .find(
            ".submit-contact-form, [name='submit'], [name='name'], [name='email'], [name='phone'], [name='address'], [name='city'], [name='zipcode'], [name='message']"
          )
          .qtip("destroy");
        if (typeof json.isOk != "undefined" && json.isOk) {
          ...
          if (
            typeof json.error_phone != "undefined" &&
            json.error_phone != ""
          ) {
            self
              .find("[name='phone']")
          ...
          if (
            typeof json.error_address != "undefined" &&
            json.error_address != ""
          ) {
            self
              .find("[name='address']")
          ...
          if (
            typeof json.error_zipcode != "undefined" &&
            json.error_zipcode != ""
          ) {
            self
              .find("[name='zipcode']")
  ...
  End of old Firebase handler */

  if ($(".header-container").hasClass("sticky")) {
    menu_position = $(".header-container").offset().top;
    $(".header-container.sticky").after(
      $(".header-container.sticky").clone().attr("id", "cm-sticky-clone")
    );
  }
  function animateElements() {
    $(
      '.animated-element, .header-container.sticky:not("#cm-sticky-clone"), .cm-smart-column'
    ).each(function () {
      var elementPos = $(this).offset().top;
      var topOfWindow = $(window).scrollTop();
      var animationStart =
        typeof $(this).data("animation-start") != "undefined"
          ? parseInt($(this).data("animation-start"), 10)
          : 0;
      if ($(this).hasClass("cm-smart-column")) {
        ...
        elementPos <
        topOfWindow + $(window).height() - 20 - animationStart
      ) {
        if (
